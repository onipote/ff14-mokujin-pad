...
const STK_FRAME_W_PCT  = 32.990;   // フレーム幅（フィールドwidth比%）
const STK_FRAME_H_PCT  = 32.990;   // フレーム高さ（フィールドheight比%）= W_PCTと同値→3:2比率
const STK_FRAME_HALF_W = 0.32990; // 正規化半幅 = (STK_FRAME_W_PCT/2) / 50
const STK_FRAME_HALF_H = 0.32990; // 正規化半高 = (STK_FRAME_H_PCT/2) / 50
